...
$sql = "SELECT * FROM proveedores"; // Asegúrate de que este es el nombre correcto de tu tabla
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $proveedores[] = $row; // Almacena cada fila en el array
    }
}
...
<body>
    ...
    <a href='actualizarPro.php?id=" . $row["ID_Proveedor"] . "' class='btn btn-update'>Actualizar</a>    |    
<a href='borrarPro.php?id=" . $row["ID_Proveedor"] . "' class='btn btn-delete'>Borrar</a>
                                 </td>";
                            echo "</tr>";
                        }
                    } else {
